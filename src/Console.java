...
//    public void archive() {
//        System.out.println("Please enter the cutoff date in yyyy-MM-dd format");
//        input = scanner.next();
//
//        String pattern = "yyyy-MM-dd";
//        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(pattern);
//        java.sql.Date cutOffDate = null;
//        try {
//            java.util.Date date = simpleDateFormat.parse(input);
//            cutOffDate = new java.sql.Date(date.getTime());
//        } catch (ParseException e) {
//            // TODO Auto-generated catch block
//            e.printStackTrace();
//        }
//        Functions.archiveGrades(conn, cutOffDate);
//    }
